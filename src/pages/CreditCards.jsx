  ...
  return (
    ...
    >
      <div className="absolute left-[8%] top-[7%] w-full h-full">
        ...
        <button className="mt-[4%] border border-neutral-600 text-white w-[33%] h-[7%] text-sm  font-bold px-3 py-2 flex justify-center items-center space-x-2">
          <div>KNOW MORE</div>
          <svg
            width="19"
            height="8"
...
export const CreditCards = () => {
  return (
    <div className="relative min-h-[160vh] bg-black w-screen text-white px-4 py-16">
