...
export const Iphone = () => {
    return (
        <div className=" relative min-h-[160vh] w-screen overflow-hidden  bg-black">
    <div className="absolute top-0 left-0 w-full h-[1px] bg-gradient-to-r from-black via-white to-black"></div>
